...
namespace EcommerceProductManagement.Migrations
{
    ...
    [Migration("20240928191114_AdditionalSeedData")]
            ...
            modelBuilder.Entity("EcommerceProductManagement.Models.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2024, 9, 19, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(909)
                        },
                        new
                        {
                            Id = 2,
                            CustomerName = "Last 2Month",
                            OrderDate = new DateTime(2024, 7, 29, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(922)
                        },
                        new
                        {
                            Id = 3,
                            CustomerName = "Last 3Month",
                            OrderDate = new DateTime(2024, 6, 29, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(925)
                        },
                        new
                        {
                            Id = 4,
                            CustomerName = "Last Month Jerald",
                            OrderDate = new DateTime(2024, 8, 29, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(927)
                        },
                        new
                        {
                            Id = 5,
                            CustomerName = "Last Month Kristian",
                            OrderDate = new DateTime(2024, 9, 1, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(928)
                        },
                        new
                        {
                            Id = 6,
                            CustomerName = "Last Month Samonte",
                            OrderDate = new DateTime(2024, 9, 9, 3, 11, 14, 168, DateTimeKind.Local).AddTicks(929)
                        });
                });
